...
import ColorLogger from '../../../src/utils/colorLogger';
...
describe('DockerEventsListener', function () {
    ...
    describe('#constructor', function () {
        context('when instantiating w/o arguments', function () {
            ...
            it('must set @debug to false', function () {
                expect(dockerEventsListener.debug).to.be.false;
            });
        ...
        context('when instantiating with arguments', function () {
            beforeEach(function () {
                dockerEventsListener = new DockerEventsListener(true, ColorLogger);
            });
            ...
            it('must set @debug to true', function () {
                expect(dockerEventsListener.debug).to.be.true;
            });

            it('must set @logger to ColorLogger', function () {
                expect(dockerEventsListener.logger).to.eql(ColorLogger);
            });
        });
    });
