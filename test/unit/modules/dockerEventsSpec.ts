...
import type DockerEventsDefault from '@root/modules/dockerEvents.js'
...
describe('DockerEvents module', function () {
    let DockerEvents: typeof DockerEventsDefault
    ...
    describe('#_onExit', function () {
        ...
        let originalParentProcess: typeof DockerEventsDefault.parentProcess
        ...
        beforeEach(() => {
            ...
            DockerEvents.parentProcess = {
                connected: true,
                send: sendMock as unknown as typeof DockerEventsDefault.parentProcess.send,
                on: vi.fn()
            }
        })
